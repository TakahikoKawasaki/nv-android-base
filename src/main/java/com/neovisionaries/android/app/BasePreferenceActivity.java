...
/**
 * Base class for {@code PreferenceActivity}'s that honor the chain
 * of {@code finish()} mechanism.
 *
 * <p>
 * {@code onResume()} method of subclasses of {@code BasePreferenceActivity}
